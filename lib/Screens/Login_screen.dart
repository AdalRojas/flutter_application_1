...
class _LoginScreenState extends State<LoginScreen> {
  ...
  controller; //Controlador de la maquina de estados (veo loq ue este cabiando)
  SMIBool? isChecking; //Booleano que me dice si esta chequeando o no
  SMIBool? isHandsUp; //Booleano que me dice si las manos
  SMITrigger?
  trigSuccess,
  trigFail; //Booleano que me dice si tuvo exitoeano que me dice si tuvo fracaso
  SMINumber? numLook;
  ...
  void initState() {
    ...
    myFocusNode.addListener(() {
      if (!myFocusNode.hasFocus) {
        // El TextField perdió el foco (por tocar fuera)
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                autofocus: true,
                onTap: () {
                  // Cuando el usuario toca el TextField
                  myFocusNode2.requestFocus();
                  isHandsUp!.change(false);
                  numLook!.value = (1 * 3).toDouble().clamp(0, 60);
                },
                /*onChanged: (value){
                    if (isHandsUp != null) {
                      isHandsUp!.change(false);
